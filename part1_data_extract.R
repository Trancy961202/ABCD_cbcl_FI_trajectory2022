...
data_cbcls_base<-cbcls[cbcls$eventname=="baseline_year_1_arm_1",c("src_subject_id","eventname","interview_age","sex",
                                                                  ...
                                                                  "cbcl_scr_dsm5_conduct_r","cbcl_scr_syn_external_r","cbcl_scr_syn_internal_r","cbcl_scr_syn_totprob_r")]
...
summary(data_1_1_1)
rm(nda)
save.image("r0901_noimpute_1.RData")
...
save.image("r0901_noimp_tbss.RData")
...
rm(list = ls())
load("data/r0901_noimpute_1.RData")
library(mice)
...
#combination of cbcls and tbss
data_cbcls_tbss<-cbind(data_1_1_1,data_tbss_base[match(data_1_1_1$src_subject_id,data_tbss_base$src_subject_id),])
save.image("data/r0901_tbss.RData")
...
save.image("data/inter_slope0901.RData")
...
df$src_subject_id
sum(is.na(df$anxi))
save.image("data/r0901_smri.RData")
...
save.image("data/inter_slope_dmri0902.RData")
...
load("data/inter_slope_dmri0902.RData")
...
df$src_subject_id
sum(is.na(df$anxi))
save.image("data/r0902_dmri.RData")
