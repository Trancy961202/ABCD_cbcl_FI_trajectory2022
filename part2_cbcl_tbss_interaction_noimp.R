load("/home/luoqiang/lqy/r0901/step1/demo/r0901_noimp_tbss.RData")
...
###  2.2 association between cbcl and tbss(no impute) #########
...
outfile.name <- 'interaction_cbcls_tbss_noimp0901.csv'
...
stopImplicitCluster()
save.image("result0901_cbcl_tbss_interaction_noimp.RData")